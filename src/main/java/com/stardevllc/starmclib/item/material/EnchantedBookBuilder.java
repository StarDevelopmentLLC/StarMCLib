package com.stardevllc.starmclib.item.material;
...
public class EnchantedBookBuilder extends ItemBuilder {
    ...
    public void saveToConfig(ConfigurationSection section) {
        ...
        storedEnchants.forEach((enchant, level) -> section.set("storedenchantments." + enchant.getKey().toString().replace(":", "_"), level));
    }
    ...
    @Override
    public EnchantedBookBuilder addAttributeModifier(Attribute attribute, String name, double amount, AttributeModifier.Operation operation, EquipmentSlot slot) {
        super.addAttributeModifier(attribute, name, amount, operation, slot);
        return this;
    }

    @Override
    public EnchantedBookBuilder addAttributeModifier(Attribute attribute, String name, double amount, AttributeModifier.Operation operation) {
