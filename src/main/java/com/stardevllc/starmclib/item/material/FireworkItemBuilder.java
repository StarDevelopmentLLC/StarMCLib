...
public class FireworkItemBuilder extends ItemBuilder {
    ...
    protected static FireworkItemBuilder createFromConfig(ConfigurationSection section) {
        ...
        if (effectsSection != null) {
            for (String key : effectsSection.getKeys(false)) {
                FireworkEffect object = effectsSection.getObject(key, FireworkEffect.class);
    ...
    @Override
    public FireworkItemBuilder addAttributeModifier(Attribute attribute, String name, double amount, AttributeModifier.Operation operation, EquipmentSlot slot) {
        super.addAttributeModifier(attribute, name, amount, operation, slot);
        return this;
    }

    @Override
    public FireworkItemBuilder addAttributeModifier(Attribute attribute, String name, double amount, AttributeModifier.Operation operation) {
